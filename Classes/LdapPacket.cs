...
namespace Flexinets.Ldap
{
    public class LdapPacket : LdapAttribute
    {
        public Int32 MessageId
        {
            get
            {
                return Convert.ToInt32(ChildAttributes[0].GetValue());  // todo this should be an int32...                
            }
        }
        ...
        {
            ChildAttributes.Add(new LdapAttribute(UniversalDataType.Integer, false) { Value = new Byte[] { (byte)messageId } });
        }
